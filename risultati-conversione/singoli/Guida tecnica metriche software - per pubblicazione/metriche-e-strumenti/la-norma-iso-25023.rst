...
.. _misurazioni-di-prestazioneefficienza:
...
Per ciascuna di queste sottocaratteristiche, la ISO 25023 propone alcune metriche [2]_, che vengono illustrate nei paragrafi che seguono, fornendo per ciascuna di esse indicazioni e suggerimenti d'uso nel contesto del Tavolo di lavoro (vale a dire, analisi e valutazione quantitativa di applicazioni software considerate in termini di prodotto).

.. _metriche-per-tempi-di-risposta:

Metriche per "tempi di risposta"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Per la prima delle tre sottocaratteristiche, la ISO 25023 propone 5 metriche, pensate per misurare i tempi di elaborazione di un software [3]_ nell'erogazione delle sue funzioni.
...
.. _metriche-per-consumo-di-risorse:
...
.. _conclusioni-su-prestazioneefficienza:
...
.. _metriche-per-appropriatezza---riconoscibilità:

Metriche per "appropriatezza - riconoscibilità"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Per la prima delle cinque sottocaratteristiche, la ISO 25023 propone 3 metriche, pensate per misurare quanto un software [4]_ appare intuitivo all'utente, nel senso che mostra all'utente come deve essere usato per raggiungere l'obiettivo.
...
.. _metriche-per-protezione-da-errore-utente:
...
.. _metriche-per-estetica-dellinterfaccia-utente:
...
.. _metriche-per-tolleranza-agli-errori:
...
.. _misurazioni-di-manutenibilità:
...
.. _conclusioni-su-manutenibilità:
...
.. _misurazioni-di-idoneità-funzionale:
...
.. _conclusioni-su-idoneità-funzionale:
